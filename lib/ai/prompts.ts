...
6. اجعل الفقرات قصيرة (3-5 جمل كحد أقصى)
7. أضف جمل انتقالية بين الفقرات
8. اختم بخاتمة قوية تلخص النقاط الرئيسية
9. عالج مشاكل SEO المذكورة أعلاه
10. حافظ على جميع المعلومات والحقائق الأساسية
11. استخدم أسلوباً صحفياً احترافياً بالعربية الفصحى

تحسينات GEO (لمحركات البحث الذكية مثل ChatGPT وPerplexity):
12. اكتب الفقرة الأولى بأسلوب "الإجابة أولاً": ابدأ بحقيقة مباشرة تجيب على من/ماذا/متى/أين (تجنب البدء بـ "هناك" أو "تشهد" أو "يعتبر" أو "تعد" أو أي عبارات مبهمة)
13. استخدم جملاً قصيرة (متوسط 15-20 كلمة) لتسهيل الاستخراج من محركات الذكاء الاصطناعي
14. يجب تنظيم المعلومات القابلة للتعداد (أسباب، نتائج، خطوات، مميزات) في قوائم باستخدام <ul> أو <ol> مع <li>
15. يجب إضافة قسم <h2>أسئلة شائعة</h2> في نهاية المقال مع إجابات مختصرة على الأسئلة المتوقعة
16. يجب إضافة اقتباس واحد على الأقل من مصدر أو خبير باستخدام علامات «نص الاقتباس هنا» أو وسم <blockquote>نص الاقتباس</blockquote>
17. يجب تضمين أرقام وإحصائيات ونسب مئوية بمعدل لا يقل عن رقمين لكل 100 كلمة (أعداد، تواريخ، نسب، إحصائيات، أرقام دقيقة)
...
أعد JSON فقط بالشكل التالي:
{
  ...
  "rewrittenTitle": "العنوان المحسّن (اختياري - اتركه null إذا كان العنوان الأصلي جيداً)",
  "changesSummary": [
    "تحسين 1: وصف التحسين",
    "تحسين 2: وصف التحسين",
    "تحسين 3: وصف التحسين"
